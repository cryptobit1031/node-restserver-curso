...
//--------------------------------------------------------------------------------------
// Configuraciones de google - función de google
//--------------------------------------------------------------------------------------
    ...
    Usuario.findOne( {email: googleUser.email}, (err, usuarioDB) => {
        ...
        if ( usuarioDB ) {
            ...
            if ( usuarioDB.google === false ) {
                ...
                // Creamos o actualizamos el token y le asignamos una caducidad
                let token = jwt.sign({
                    usuario: usuarioDB,
            ...
            // Si el usurio no existe en nuestra base de dstos
